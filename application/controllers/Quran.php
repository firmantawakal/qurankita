...
class Quran extends CI_Controller{
	...
	public function index()
	{
		...
		$data['quran']	= $this->m_quran->tampil_data('surah', $data['keyword'])->result_array();
	...
	public function ayat()
	{
		...
		$data['surat']	= $this->m_quran->tampil_data('surah', $data['keyword'])->result();
	...
	public function card()
	{
		...
		$data['surat']	= $this->m_quran->tampil_surah('surah', $data['keyword'])->result_array();
	...
	public function cardAyat()
	{
		...
		$data['surat']	= $this->m_quran->tampil_data('surah', $data['keyword'])->result_array();
	...
	public function murottal()
	{
		...
		$data['murottal']	= $this->m_quran->tampil_murottal('murottal', $data['keyword'])->result_array();
	...
	{
		$data['user']  		= $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
		$data['detail'] 	= $this->m_quran->detail_quran($id);
		$data['ustadz']  	= $this->db->get_where('ustadz', ['email' => $this->session->userdata('email')])->row_array();
		...
		if($id == 1){
	        ...
	        $this->template->load('template','quran/Al Quran',$data);
